...
function CreateListing() {
  ...
  function onChange(e) {
    ...
    if (!e.target.files) {
      setFormData((prevState) => ({
        ...prevState,
        [e.target.id]: boolean ?? e.target.value, //??= if null
      }));
    }
  }
      ...
      <form onSubmit={onSubmit}>
          ...
          <div className="flex space-x-6 justify-start mb-6">
            <div className="">
              ...
              <input
                ...
                min="-90"
                max="90"
                className="w-full px-4 py-2 text-xl text-gray-700 bg-white borderborder-gray-300 rounded transition duration-150 ease-in-out
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-out
        ...
        shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150
        ease-in-out"
        >
          Create Listing
        </button>
